      ...
      <div className="min-h-screen text-white font-sans relative flex flex-col items-center justify-start px-0 selection:bg-purple-500 selection:text-white pt-[72px]">
        ...
        <div className="w-full max-w-[620px] mx-auto z-10 pb-24 px-4">
          ...
          <div className="text-center mb-8">
            <div className="text-[#95BE62] text-xl mb-2">
              😈 당신이 주인공이 되는 게임예능 현실판! 😈
            </div>
            <h1 className="text-4xl font-bold text-white mb-2">REAL GENIUS</h1>
            <p className="text-xl text-purple-300">
              매주 일요일, 스릴 넘치는 심리전 속에서
              <br />
              새로운 찐친들을 만나보세요! 😉
            </p>
          </div>
          ...
          <div className="mb-10 bg-black/50 backdrop-blur-[30px] p-6 rounded-xl">
            <div className="mb-4 text-center">
              <p className="text-lg text-[#95BE62] mb-1">
                🤯 &quot;게임예능이라니, 너무 어렵진 않을까?&quot;
              </p>
              <p className="text-lg text-[#95BE62] mb-2">
          ...
          <div className="mb-10 bg-black/50 backdrop-blur-[30px] p-6 rounded-xl border-l-4 border-[#95BE62]">
            <div className="bg-[#95BE62]/10 rounded-lg p-3 mb-4 inline-block">
              <h3 className="text-xl font-extrabold text-[#95BE62]">
                [Point 1]
              </h3>
            </div>
            ...
            <p className="mb-4">
              저희는, 방송보다 더 재밌는 경험을 만들어드리는 걸 핵심 가치로 삼고
              있어요!
            </p>
            <p className="mb-4">
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="w-full md:w-2/3 p-4">
                    <p className="text-lg mb-3">
                      밤이 돼도 못 자...? 모두 눈을 뜬 채 능력을 쓰대! 분명
                      죽었는데 죽지 않는 마피아라니... 서로의 정체는 끝까지
                      모르니 긴장감 MAX!
                    </p>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="w-full md:w-2/3 p-4">
                    <p className="text-lg mb-3">
                      ...
                      랜덤으로 받아, 동맹이 시시각각 바뀐다! 모두의 심리를
                      예측하라! 🔮
                    </p>

                    <div className="flex items-center justify-between mb-2">
                      <span className="bg-teal-500/80 text-white px-3 py-1 rounded-full text-sm">
                        난이도 : 중간
                      </span>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="w-full md:w-2/3 p-4">
                    <p className="text-lg mb-3">
                      ...
                      상대 조직의 보스가 지목 되다면 공들이 카치노는 우리 조직
                      차지✌️
                    </p>
