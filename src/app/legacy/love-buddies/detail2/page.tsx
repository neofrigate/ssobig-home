...
const faqQuestions = [
  {
    question: "어떻게 신청하나요?",
    answer:
      "페이지 하단의 <참가 신청하기> 버튼을 클릭하고<br/>양식에 맞춰 답변을 제출해주시면 됩니다!<br/>신청 후 발송되는 안내 문자에 따라 결제까지 마쳐주셔야 최종 신청 완료이니,<br/>꼭 안내 문자 확인 후 결제 부탁드립니다!",
  },
  {
    question: "혼자 참여 가능한가요?",
    answer:
      "물론이죠!<br/>대부분 혼자 오시고, 오히려 새로운 사람들과 일일남매 콘텐츠를 하다 보면 금방 친해지세요!<br/>다양한 활동과 '함께 좋은 사람을 찾아준다'는 목표가 어색함을 눈 녹이듯 사라지게 할 거예요.<br/>새로운 진친을 만들 절호의 기회!",
  },
  {
    question: "어떤 분들이 참여하시나요?",
    answer:
      "정말 다양하고 매력적인 분들이 많이 찾아주세요!<br/>20~35세의 다양한 직군, 전공의 사람들이 참여합니다.<br/>진정한 인연을 찾고, 새로운 사람들과의 즐거운 만남을 기대하는 긍정적이고 매력적인 분들이 대부분입니다.<br/>분위기는 늘 따뜻하고 진정성 있어요! <br/>걱정 말고 오셔서 함께 즐겨요!",
  },
  {
    question: "일정이 몇 시간 지속되나요?",
    answer:
      "게더링은 2시간 30분 진행됩니다.<br/>다만, 원하는 참석자에 따라서 더욱 길어질 수 있으며,<br/>게더링 종료 시, 2차를 통해 추가로 소통하실 수 있습니다!",
  },
  {
  ...
  {
    question: "일일남매는 어떤 의미인가요?",
    answer:
      "일일남매는 하루 동안 남매가 되어 서로의 이상형이나 좋은 친구를 찾아주는 특별한 콘셉트입니다!<br/><br/>기존 소개팅이나 미팅과는 달리, 직접적인 어필보다는<br/>남매라는 안전한 관계에서 서로를 도와주며 자연스럽게 다른 참가자들과 친해질 수 있어요.<br/><br/>이를 통해 부담 없이 다양한 사람들과 교류하고<br/>진정성 있는 관계를 형성할 수 있습니다!",
  },
  {
    question: "음식과 다과를 제공하나요?",
    answer:
      "서로 만남 시간을 편하게 만들어 주는 다과와 음료를 함께 제공합니다!<br/>음료와 더불어 동서양 음식 셀렉션이 개인 취향에 맞게 제공됩니다.<br/><br/>개인적으로 식사를 하고 오셔도 자유롭게 참여하셔도 됩니다 :)<br/><br/>다만, 몰입을 위해 게더링 중에는 간단한 다과 위주로 제공되고,<br/>게더링이 끝난 뒤 희망자에 한해 2차 장소로 이동해<br/>본격적인 식사 및 대화를 이어가는 시간을 가져요!",
  },
  {
    question: "어떤 옷차림이 적합한가요?",
    answer:
      "스타일은 자유롭게 개더링 참여에 적합한 복장이면 괜찮습니다.<br/>드레스코드는 편하면서 개더링 진행 시 활동에 방해가 되지 않는 복장이면 됩니다.<br/><br/>가벼운 캐주얼이면 괜찮습니다!<br/>게더링 진행 중 다양한 활동들이 있으니 활동하기 편한 복장을 추천합니다.<br/><br/>너무 격식을 차린 정장보다는 편안하면서도 깔끔한 복장이 좋아요!",
  },
  {
    question: "게더링 장소는 어디인가요?",
    answer:
      "게더링 장소는 신청 후 개별적으로 안내드립니다.<br/>주로 접근성이 좋은 서울 시내 카페나 라운지에서 진행되며,<br/>편안하고 프라이빗한 공간에서 개더링이 이루어집니다.<br/><br/>정확한 위치와 오시는 길은 게더링 하루 전날<br/>카카오톡으로 일괄 전송드리고 있습니다 :)",
  },
];
